...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
                <th scope="row"><label>网站首页公告</label></th>
                <td>
                    <textarea style="width:35em; height:2em;" name="Dchaser_notices"><?php echo get_option("Dchaser_notices"); ?></textarea>
                    <br />
                    <span class="description">输入网站首页公告</span>
                </td>
        	</tr>
